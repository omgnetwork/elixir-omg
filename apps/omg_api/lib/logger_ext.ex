...
# defmodule OMG.API.LoggerExt do
#  @moduledoc """
...
defmodule OMG.API.LoggerExt do
  ...
  def format(level, message, timestamp, metadata) do
    ...
    if env && Regex.match?(Regex.compile!(env), get_metadata_as_string(metadata, :module)) do
      ""
    else
      format_(level, message, timestamp, metadata)
    end
  end

  defp format_(level, message, _timestamp, metadata) do
