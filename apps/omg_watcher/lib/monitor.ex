...
defmodule OMG.Watcher.Monitor do
  ...
  Children that need Ethereum client connectivity are OMG.Sync.EthereumEventListener
  OMG.API.BlockQueue.Server and OMG.Sync.RootChainCoordinator. For these children, we make
