...
defmodule OMGWatcher.Eventer.Event do
  alias OMG.API.Block
  alias OMG.API.State.Transaction

  @type t ::
          OMGWatcher.Eventer.Event.AddressReceived.t()
          | OMGWatcher.Eventer.Event.InvalidBlock.t()
          | OMGWatcher.Eventer.Event.BlockWithHolding.t()
