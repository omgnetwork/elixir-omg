...
defmodule OMG.Watcher.ExitProcessor.Canonicity do
  ...
  defp prepare_competitor_response(
    ...
    %{
      ...
      competing_tx_pos: known_tx_utxo_pos || %OMG.InputPointer{blknum: 0, txindex: 0, oindex: 0},
  ...
  defp maybe_calculate_proof(%OMG.InputPointer{blknum: blknum, txindex: txindex, oindex: _}, blocks) do
    blocks
