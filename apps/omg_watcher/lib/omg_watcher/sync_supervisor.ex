    ...
    [
      ...
      {EthereumEventAggregator,
       ...
       events: [
         ...
         [name: :in_flight_exit_challenged],
         [name: :in_flight_exit_challenge_responded],
         [name: :in_flight_exit_input_blocked],
         [name: :in_flight_exit_output_blocked],
         [name: :in_flight_exit_input_withdrawn],
         [name: :in_flight_exit_output_withdrawn]
       ]},
