...
defmodule OmgWatcher.SyncSupervisor do
  @moduledoc """
  ...
  alias OmgWatcher
  alias OmgWatcher.CoordinatorSetup
  alias OmgWatcher.Monitor
  ...
  defp monitor_children do
    [
      %{
        id: OmgWatcher.BlockGetter.Supervisor,
        start: {OmgWatcher.BlockGetter.Supervisor, :start_link, []},
        restart: :permanent,
        type: :supervisor
      },
      ...
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: fn deposits ->
          OmgWatcher.DB.EthEvent.insert_deposits!(deposits)
          {:ok, []}
        end
      ),
      ...
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: &OmgWatcher.ExitProcessor.new_exits/1
      ),
      ...
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: fn exits ->
          exits |> OmgWatcher.DB.EthEvent.insert_exits!()
          {:ok, []}
        end
      ),
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: &OmgWatcher.ExitProcessor.finalize_exits/1
      ),
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: &OmgWatcher.ExitProcessor.challenge_exits/1
      ),
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: &OmgWatcher.ExitProcessor.new_in_flight_exits/1
      ),
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: &OmgWatcher.ExitProcessor.piggyback_exits/1
      ),
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: &OmgWatcher.ExitProcessor.new_ife_challenges/1
      ),
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: &OmgWatcher.ExitProcessor.respond_to_in_flight_exits_challenges/1
      ),
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: &OmgWatcher.ExitProcessor.challenge_piggybacks/1
      ),
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: &OmgWatcher.ExitProcessor.finalize_in_flight_exits/1
      )
    ]
  end
end
