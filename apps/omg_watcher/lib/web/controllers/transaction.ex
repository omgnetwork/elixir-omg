      ...
      Transaction:
        swagger_schema do
          ...
          properties do
            ...
            blknum1(:integer, "Childchain block number of first input utxo", required: true)
            txindex1(:integer, "Transaction index of first input utxo", required: true)
            ...
            spender1(:string, "Address of owner of first input utxo", required: true)
            spender2(:string, "Address of owner of second input utxo", required: true)
          end
