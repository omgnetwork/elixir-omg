...
defmodule OMG.SignatureTest do
  ...
  test "recover_public/2 recovers from a correctly signed hash" do
    hash =
      <<192, 246, 16, 42, 159, 28, 45, 134, 255, 93, 206, 125, 167, 186, 28, 209, 102, 21, 52, 86, 142, 58, 77, 241,
        185, 233, 135, 211, 223, 46, 55, 82>>

    sig =
      <<168, 39, 110, 198, 11, 113, 141, 8, 168, 151, 22, 210, 198, 150, 24, 111, 23, 173, 42, 122, 59, 152, 143, 224,
        214, 70, 96, 204, 31, 173, 154, 198, 97, 94, 203, 172, 169, 136, 182, 131, 11, 106, 54, 190, 96, 128, 227, 222,
        248, 231, 75, 254, 141, 233, 113, 49, 74, 28, 189, 73, 249, 32, 89, 165, 27>>

    {:ok, public_key} = Signature.recover_public(hash, sig)

    assert public_key ==
             <<67, 110, 140, 160, 152, 222, 61, 201, 142, 105, 11, 239, 29, 2, 105, 112, 104, 102, 237, 209, 235, 34,
               63, 70, 212, 103, 156, 70, 150, 8, 99, 18, 165, 109, 77, 77, 102, 158, 13, 249, 205, 76, 151, 41, 171,
               144, 32, 237, 9, 42, 58, 61, 128, 108, 97, 21, 8, 250, 80, 112, 200, 197, 40, 8>>
  end
end
