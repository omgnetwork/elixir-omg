...
defmodule OMG.WatcherSecurity.BlockGetter.Status do
  @moduledoc """
  ...
  @doc """
  Retrieves the freshest information about `OMG.WatcherSecurity.BlockGetter`'s status.
  Prefer `OMG.WatcherSecurity.BlockGetter.get_events/0` to this
  """
