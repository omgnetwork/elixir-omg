...
defmodule OMG.WatcherSecurity.ExitProcessor.Core do
  @moduledoc """
  ...
  For the imperative shell, see `OMG.WatcherSecurity.ExitProcessor`
  """
  ...
  alias OMG.WatcherSecurity.ExitProcessor.CompetitorInfo
  alias OMG.WatcherSecurity.ExitProcessor.ExitInfo
  alias OMG.WatcherSecurity.ExitProcessor.InFlightExitInfo
  alias OMG.WatcherSecurity.ExitProcessor.KnownTx
  alias OMG.WatcherSecurity.ExitProcessor.StandardExit

  import OMG.WatcherSecurity.ExitProcessor.Tools
