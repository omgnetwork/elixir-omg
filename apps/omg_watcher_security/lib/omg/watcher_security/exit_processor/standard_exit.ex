...
defmodule OMG.WatcherSecurity.ExitProcessor.StandardExit do
  @moduledoc """
  Part of Core to handle SE challenges & invalid exit detection.

  Treat as private helper submodule of `OMG.WatcherSecurity.ExitProcessor.Core`, test and call via that
  """
  ...
  alias OMG.WatcherSecurity.ExitProcessor.DoubleSpend
  alias OMG.WatcherSecurity.ExitProcessor.ExitInfo
  alias OMG.WatcherSecurity.ExitProcessor.KnownTx
  alias OMG.WatcherSecurity.ExitProcessor.TxAppendix
