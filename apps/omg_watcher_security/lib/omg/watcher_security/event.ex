...
defmodule OMG.WatcherSecurity.Event do
  @moduledoc """
  ...
  @type byzantine_t ::
          OMG.WatcherSecurity.Event.InvalidBlock.t()
          | OMG.WatcherSecurity.Event.BlockWithholding.t()
          | OMG.WatcherSecurity.Event.InvalidExit.t()
          | OMG.WatcherSecurity.Event.UnchallengedExit.t()
          | OMG.WatcherSecurity.Event.NonCanonicalIFE.t()
          | OMG.WatcherSecurity.Event.InvalidIFEChallenge.t()
          | OMG.WatcherSecurity.Event.PiggybackAvailable.t()
          | OMG.WatcherSecurity.Event.InvalidPiggyback.t()

  @type t :: OMG.WatcherSecurity.Event.AddressReceived.t() | OMG.WatcherSecurity.Event.ExitFinalized.t() | byzantine_t()
