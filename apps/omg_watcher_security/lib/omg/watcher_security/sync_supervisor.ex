...
defmodule OMG.WatcherSecurity.SyncSupervisor do
  @moduledoc """
  ...
  alias OMG.WatcherSecurity.CoordinatorSetup
  ...
  def children() do
    [
      %{
        id: OMG.WatcherSecurity.BlockGetter.Supervisor,
        start: {OMG.WatcherSecurity.BlockGetter.Supervisor, :start_link, []},
        restart: :permanent,
        type: :supervisor
      },
      ...
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: &WatcherSecurity.ExitProcessor.new_exits/1
      ),
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: &WatcherSecurity.ExitProcessor.finalize_exits/1
      ),
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: &WatcherSecurity.ExitProcessor.challenge_exits/1
      ),
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: &WatcherSecurity.ExitProcessor.new_in_flight_exits/1
      ),
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: &WatcherSecurity.ExitProcessor.piggyback_exits/1
      ),
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: &WatcherSecurity.ExitProcessor.new_ife_challenges/1
      ),
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: &WatcherSecurity.ExitProcessor.respond_to_in_flight_exits_challenges/1
      ),
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: &WatcherSecurity.ExitProcessor.challenge_piggybacks/1
      ),
      EthereumEventListener.prepare_child(
        ...
        process_events_callback: &WatcherSecurity.ExitProcessor.finalize_in_flight_exits/1
      )
    ]
  end
end
