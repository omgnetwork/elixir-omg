...
defmodule OMG.WatcherInfo.DB.EthEvent do
  ...
  defp insert_deposit!(%{
    ...
    event_type = :deposit
    position = %OMG.InputPointer{blknum: blknum, txindex: 0, oindex: 0}
  ...
  def generate_child_chain_utxohash(%OMG.InputPointer{blknum: blknum, txindex: txindex, oindex: oindex}) do
