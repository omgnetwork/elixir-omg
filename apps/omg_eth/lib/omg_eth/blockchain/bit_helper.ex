...
defmodule Eth.Blockchain.BitHelper do
  @moduledoc """
  ...
  ## Examples
      ...
      iex>  Eth.Blockchain.BitHelper.encode_unsigned(0)
      <<>>

      iex>  Eth.Blockchain.BitHelper.encode_unsigned(5)
      <<5>>
