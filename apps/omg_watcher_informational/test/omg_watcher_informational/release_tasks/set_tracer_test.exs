...
defmodule OMG.WatcherInformational.ReleaseTasks.SetTracerTest do
  use ExUnit.Case, async: false
  alias OMG.WatcherInformational.ReleaseTasks.SetTracer
  alias OMG.WatcherInformational.Tracer
