...
defmodule OMG.WatcherInformational.Integration.TestHelper do
  @moduledoc """
  ...
  def wait_for_byzantine_events(event_names, timeout) do
    fn ->
      %{"byzantine_events" => emitted_events} = WatcherInformationalHelper.success?("/status.get")
  ...
  def wait_for_exit_processing(exit_eth_height, timeout \\ 5_000) do
    exit_finality = Application.fetch_env!(:omg_watcher_informational, :exit_finality_margin) + 1
