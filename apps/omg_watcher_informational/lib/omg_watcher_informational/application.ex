...
defmodule OMG.WatcherInformational.Application do
  @moduledoc false
  use Application
  ...
  def start_root_supervisor do
    ...
    children = [
      %{
        id: OMG.WatcherInformational.Supervisor,
        start: {OMG.WatcherInformational.Supervisor, :start_link, []},
        restart: :permanent,
        type: :supervisor
      }
    ]
    ...
    opts = [
      ...
      max_restarts: 0,
      name: OMG.WatcherInformational.RootSupervisor
    ]
