...
- "LOCALCHAIN_TXHASH_CONTRACT"
- "LOCALCHAIN_AUTHORITY_ADDRESS"
- "LOCALCHAIN_CONTRACT_ADDRESS_PLASMA_FRAMEWORK"
- "LOCALCHAIN_CONTRACT_ADDRESS_ETH_VAULT
- "LOCALCHAIN_CONTRACT_ADDRESS_ERC20_VAULT
- "LOCALCHAIN_CONTRACT_ADDRESS_PAYMENT_EXIT_GAME"
