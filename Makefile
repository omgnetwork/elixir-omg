...
cabbage-reorg-watcher_info-logs:
	docker-compose -f docker-compose.yml -f docker-compose-2-reorg.yml -f docker-compose-2-specs.yml logs --follow watcher_info

cabbage-reorg-childchain-logs:
	docker-compose -f docker-compose.yml -f docker-compose-2-reorg.yml -f docker-compose-2-specs.yml logs --follow childchain

cabbage-reorg-geth-logs:
	docker-compose -f docker-compose.yml -f docker-compose-2-reorg.yml -f docker-compose-2-specs.yml logs --follow | grep "geth"

cabbage-reorgs-logs:
	docker-compose -f docker-compose.yml -f docker-compose-2-reorg.yml -f docker-compose-2-specs.yml logs --follow | grep "reorg"
