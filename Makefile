...
init_test:
	mkdir data/ || true && \
	rm -rf data/* || true && \
	wget https://storage.googleapis.com/circleci-docker-artifacts/data-elixir-omg-tester-plasma-deployer-dev-551a2b5-MIN_EXIT_PERIOD-120-PLASMA_CONTRACTS_SHA-835d10cbe8d7ef56feb745f71de638f85f572f7d.tar.gz -O data/snapshot.tar.gz && \
