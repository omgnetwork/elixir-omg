...
config :ethereumex,
  url: System.get_env("TEST_ETHEREUM_RPC_URL", "http://localhost:8545"),
...
config :omg_watcher, child_chain_url: System.get_env("TEST_CHILDCHAIN_URL", "http://localhost:9656/v1")
...
config :omg_watcher_info, child_chain_url: System.get_env("TEST_CHILDCHAIN_URL", "http://localhost:9656/v1")
