...
defmodule OMG.LoadTesting.Connection.WatcherSecurity do
  @moduledoc """
  Module that overrides the Tesla middleware with the url in config.
  """

  alias OMG.LoadTesting.Connection.Utils

  def client() do
    base_url = Application.get_env(:omg_load_testing, :watcher_security_url)
