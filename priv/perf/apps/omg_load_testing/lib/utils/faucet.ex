...
defmodule OMG.LoadTesting.Utils.Faucet do
  ...
  alias OMG.LoadTesting.Utils.ChildChain
  alias OMG.LoadTesting.Utils.Deposit
  alias OMG.LoadTesting.Utils.Ethereum, as: Eth
  ...
  defp fetch_default_opts() do
    ...
    |> Enum.reduce([], fn key, acc ->
      [{key, Application.fetch_env!(:omg_load_testing, key)} | acc]
    end)
