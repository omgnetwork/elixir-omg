...
defmodule LoadTesting.Utils.Ethereum.Hash do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> LoadTesting.Utils.Ethereum.Hash.transaction_hash(%LoadTesting.Utils.Ethereum.Transaction{nonce: 5, gas_price: 6, gas_limit: 7, to: <<>>, value: 5, init: <<1>>})
      <<127, 113, 209, 76, 19, 196, 2, 206, 19, 198, 240, 99, 184, 62, 8, 95, 9, 122, 135, 142, 51, 22, 61, 97, 70, 206, 206, 39, 121, 54, 83, 27>>

      iex> LoadTesting.Utils.Ethereum.Hash.transaction_hash(%LoadTesting.Utils.Ethereum.Transaction{nonce: 5, gas_price: 6, gas_limit: 7, to: <<1>>, value: 5, data: <<1>>})
      <<225, 195, 128, 181, 3, 211, 32, 231, 34, 10, 166, 198, 153, 71, 210, 118, 51, 117, 22, 242, 87, 212, 229, 37, 71, 226, 150, 160, 50, 203, 127, 180>>

      iex> LoadTesting.Utils.Ethereum.Hash.transaction_hash(%LoadTesting.Utils.Ethereum.Transaction{nonce: 5, gas_price: 6, gas_limit: 7, to: <<1>>, value: 5, data: <<1>>}, 1)
  ...
  ## Examples
    ...
    iex> LoadTesting.Utils.Ethereum.Hash.sign_hash(<<2::256>>, <<1::256>>)
    {28,
    ...
    iex> LoadTesting.Utils.Ethereum.Hash.sign_hash(<<5::256>>, <<1::256>>)
    {27,
    ...
    iex> hash = LoadTesting.Utils.Ethereum.BitHelper.kec(data)
    iex> private_key = Base.decode16!("4646464646464646464646464646464646464646464646464646464646464646", case: :lower)
    iex> LoadTesting.Utils.Ethereum.Hash.sign_hash(hash, private_key, 1)
