...
defmodule LoadTesting.Utils.Ethereum.BitHelper do
  @moduledoc """
  ...
  ## Examples
      ...
      iex> LoadTesting.Utils.Ethereum.BitHelper.kec("hello world")
      <<71, 23, 50, 133, 168, 215, 52, 30, 94, 151, 47, 198, 119, 40, 99,
             132, 248, 2, 248, 239, 66, 165, 236, 95, 3, 187, 250, 37, 76, 176,
             31, 173>>

      iex> LoadTesting.Utils.Ethereum.BitHelper.kec(<<0x01, 0x02, 0x03>>)
  ...
  ## Examples
      ...
      iex> LoadTesting.Utils.Ethereum.BitHelper.encode_unsigned(0)
      <<>>

      iex> LoadTesting.Utils.Ethereum.BitHelper.encode_unsigned(5)
      <<5>>

      iex> LoadTesting.Utils.Ethereum.BitHelper.encode_unsigned(5_000_000)
      <<76, 75, 64>>
  """
